...
We adopt a distributed inference setup with data parallelism (DP) for dense layers and expert parallelism (EP) for MoE layers, without tensor parallelism. We denote configurations by their expert-parallel degree (e.g., EP-8 or EP-32); attention uses the matching data-parallel degree, and MoE experts are partitioned across the corresponding device group.
