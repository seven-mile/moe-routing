...
from customizations.deepseek_moe import MoEGate
...
def main():
    ...
    active_data.save_to_disk("data/active_data")
    ...
    model = AutoModelForCausalLM.from_pretrained("deepseek-ai/deepseek-moe-16b-chat", device_map=main_device, torch_dtype=torch.float16, attn_implementation="flash_attention_2", trust_remote_code=True)
